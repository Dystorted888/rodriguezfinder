...
export default function App() {
  ...
  if (!me && deepLinkedGroup && !havePerGroupIdentity) {
    // Deep-linked into a group without identity: force the Join form (join mode)
    content = (
      <Join
        onJoined={onJoined}
    ...
    content = <Join onJoined={onJoined} />;
  } else if (!me) {
    content = <Join onJoined={onJoined} initialGroupId={groupId} forceJoin />;
  } else if (needsPerm) {
    content = (
      <PermissionsGate
    ...
    content = <Compass onQuit={quitGroup} />;
  }
